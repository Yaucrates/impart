...
<div 
    ...
    class={`${disable ? "cursor-default" : "cursor-pointer"} w-[312px] h-96 row-span-1 overflow-hidden flex flex-col justify-between rounded-xl bg-[#252930] shadow-input transition duration-200`}
>
